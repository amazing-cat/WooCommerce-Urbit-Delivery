<form method="get" class="urb-it-postcode-validator">
	...
	<div class="field">
		<!-- <input type="text" class="input-text" name="street" value="<?= isset($street) ? $street : '' ?>" placeholder="<?php _e('Street', self::LANG); ?>" size="50" maxlength="50" /> -->
		<input type="number" class="input-text" name="postcode" value="<?= isset($postcode) ? $postcode : '' ?>" placeholder="<?php _e('Postcode', self::LANG); ?>" size="6" maxlength="6" />
		<!-- <input type="text" class="input-text" name="city" value="<?= isset($city) ? $city : '' ?>" placeholder="<?php _e('City', self::LANG); ?>" size="30" maxlength="30" /> -->
